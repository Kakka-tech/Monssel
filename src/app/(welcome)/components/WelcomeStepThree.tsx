    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3 pt-2">
        <button
          onClick={onBack}
          disabled={saving}
          className="px-4 py-2 border border-gray-200 rounded-lg text-gray-600 text-sm hover:bg-gray-50 transition-colors disabled:opacity-50"
        >
          Back
        </button>
