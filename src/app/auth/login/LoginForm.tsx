  ...
  return (
    <section className="flex min-h-screen w-full flex-col items-center justify-center bg-[#f5f6f7] px-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-8 shadow-[0_4px_16px_0_rgba(0,0,0,0.25)]">
        ...
        <h1 className="text-2xl font-semibold text-[#1E1F20]">Login</h1>
        <p className="mt-1 text-sm text-[#707375]">Welcome back to Monssel</p>
        ...
        <p className="mt-6 text-center text-sm text-[#707375]">
          ...
          <Link
            href="/auth/get-started/create-account"
      ...
      <Link
        ...
        className="mt-6 text-sm text-[#707375] hover:text-gray-600"
      >
        Forgot Password?
      </Link>
    </section>
