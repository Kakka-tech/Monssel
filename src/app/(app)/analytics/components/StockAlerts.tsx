...
function getColors(stock: number, min: number) {
...
interface StockAlertsProps {
  alerts: StockAlertProduct[];
  onViewAll?: () => void;
}

export default function StockAlerts({ alerts, onViewAll }: StockAlertsProps) {
  return (
    <div className="bg-white dark:bg-[#1E1F20] border border-[#ECEDEE] dark:border-[#2E2E2E] rounded-xl p-5 space-y-4">
      ...
      {alerts.length === 0 ?
        <p className="text-xs text-center text-[#707375] dark:text-[#A0A0A0] py-4">
